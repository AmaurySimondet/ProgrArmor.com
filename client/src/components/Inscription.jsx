...
function Inscription() {
  ...
  return (
    <div>
      ...
      {/* DIV 1 */}
      <div
        className={dimensions.width > 900 ? 'basic-flex' : 'basic-flex'}
        ...
        >
          <div style={{ width: '90%', margin: 'auto' }}>
            ...
            <h2 className="h2-inscription">
              Armes toi avec les meilleurs outils pour ta progression
            </h2>
      ...
      <div
        className={
          dimensions.width > 900 ? 'basic-flex' + ' ' + classdiv2 : 'basic-flex'
        }
      ...
      <div
        className={
          dimensions.width > 900 ? 'basic-flex' + ' ' + classdiv3 : 'basic-flex'
        }
      ...
      >
        ...
        <div
          className={
            dimensions.width > 900 ? 'basic-flexed' : 'basic-noflexed500'
          }
        >
      ...
      <div
        className={
          dimensions.width > 900 ? 'basic-flex' + ' ' + classdiv4 : 'basic-flex'
        }
      ...
      >
        ...
        >
          <div style={{ width: '90%', margin: 'auto' }}>
            ...
            <h2 className="h2-inscription">
              Enregistre même tes séances les plus farfelues avec le mode expert
              ! <br />
              <br />
      ...
      <div
        className={
          dimensions.width > 900 ? 'basic-flex' + ' ' + classdiv5 : 'basic-flex'
        }
      ...
      >
        ...
        >
          <div style={{ width: '90%', margin: 'auto' }}>
            <h1 className="h1-inscription">
              {' '}
              Ta progression doit être ta priorité.{' '}
            </h1>
            <h2 className="h2-inscription">
      ...
      {showButton && (
        <button onClick={scrollToTop} className="btn btn-dark btn-to-top">
          <img
            src={require('./../images/icons/arrow-up.webp')}
