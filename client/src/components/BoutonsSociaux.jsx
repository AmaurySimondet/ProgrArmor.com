...
function BoutonsSociaux(props){
    return(
        <div>
              <a className="btn btn btn-social btn-google" href="http://localhost:8800/user/auth/google" role="button">
              ...
              <a className="btn btn btn-social btn-facebook" href="http://localhost:8800/user/auth/facebook" role="button">
