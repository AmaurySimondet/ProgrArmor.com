...
function Accomplissement(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={
          dimensions.width < 500 ? 'achieveTxtHolderMini' : 'achieveTxtHolder'
        }
        style={props.modeSombre ? null : { background: '#aaaaaa' }}
      >
        <div
          class="achieveTxt"
          style={dimensions.width < 500 ? { padding: '0' } : null}
        >
          <h3
            class="ellipsis"
            style={props.modeSombre ? null : { color: 'black' }}
          >
            {props.titre}
          </h3>
          <h5 style={props.modeSombre ? null : { color: '#222222' }}>
            {props.description}
          </h5>
        </div>
