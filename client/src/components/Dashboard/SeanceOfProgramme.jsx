...
function SeanceOfProgramme(props) {
  ...
  return (
    <div>
        ...
        {props.closedPeriodisation ? (
          ...
          <div>
            <h2
              ...
              onClick={handleClickSeance}
              className="basic-margin-bottom"
            >
          ...
          ? seance.exercices.map((exercice, index) => {
              return (
                <div>
                  ...
                  <button
                    className="btn btn-dark form-button large-margin-bottom"
                    id={index}
      ...
      {props.closedPeriodisation ? null : seance.exercices[0] ? null : (
        <button
          className="btn btn-dark form-button large-margin-bottom"
          onClick={onAddExercices}
          type="submit"
      ...
      {props.closedPeriodisation ? null : clickSeance ? null : (
        <div className="col-12">
          <label className="col-form-label" style={{ fontWeight: '800' }}>
