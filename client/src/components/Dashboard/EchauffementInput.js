...
function EchauffementInput(props) {
  const [series, setSeries] = useState([
    ...Object.values(props.echauffement.Series),
  ]);
  const [categories, setCategories] = useState([
    ...Object.values(props.echauffement.Categories),
  ]);
  ...
  return (
    <div className="exercice-div">
      ...
      <ExerciceEchauffementInput
        ...
        value={echauffement.exercice}
        index={props.index}
        onDeleteEchauffements={props.onDeleteEchauffements}
        changeEchauffement={changeEchauffement}
