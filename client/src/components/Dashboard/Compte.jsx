...
function Compte() {
  ...
  async function handleClickUpdateUser(event) {
    ...
    if (password && cpassword) {
      ...
      if (password !== cpassword)
        return alert(
          "Doucement sur la picole t'as pas écris deux fois la même chose !"
        );
      if (user.googleId || user.facebookId)
        return alert(
          'Impossible de modifier le mdp pour les utilisateurs google et facebook !'
        );
      else {
        const res = await API.modifyUser({
          id: localStorage.getItem('id'),
    ...
    <div>
      ...
      {modifyInfo ? (
        <form className="modify-info-form">
          ...
          <br />
          <button
            className="btn btn-dark btn-lg btn-arriere"
        ...
        <form className="modify-info-form">
          ...
          <button
            className="btn btn-dark btn-lg btn-arriere"
            onClick={handleModifyPasswordForm}
            block="true"
            type="submit"
          >
            Revenir en arrière
        ...
        <div className="Compte">
                ...
                {user.profilePic ? (
                  ...
                  <td>
                    ...
                    >
                      ...
                      />
                      <img
                        className="unknown-profile-pic profile-pic"
          ...
          <div className="small-profile">
            {user.profilePic ? (
              ...
              >
                ...
                />
                <img
                  className="unknown-profile-pic profile-pic profile-pic-small"
                  src={require('../../images/profilepic.webp')}
                  alt="unknown-profile-pic"
                />
                <p> {text} </p>
            ...
            <button
              className="btn btn-dark profile-btn profile-btn-small"
              onClick={handleModifyForm}
              block="true"
              type="submit"
            >
          ...
          <button
            ...
            onClick={() => {
              window.location = '/profil?id=' + user.id;
            }}
          >
            Voir profil en ligne
          </button>
          <button
            className="btn btn-black btn-lg profile-disconnect-btn"
            onClick={disconnect}
            block="true"
            type="submit"
          >
