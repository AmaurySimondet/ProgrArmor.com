...
function Dashboard() {
  ...
  const [params, setParams] = useState({
    ...
    nom: '',
    periode: 'max',
    tri: 'Ordre chronologique décroissant',
    repsFrom: '',
    repsTo: '',
    exerciceName: 'title',
    exerciceOwnExercice: '',
  ...
  const [checkbox, setCheckbox] = useState({
    affichageCharge: true,
    affichageReps: true,
    affichageNom: true,
    affichageDate: true,
    affichageExercice: true,
    affichageType: false,
    affichagePercent: true,
    affichagePoids: false,
    affichageModif: false,
    affichageSuppr: false,
  ...
  async function getUser() {
    ...
    if (data.success === false) {
      ...
      arr.push({
        id: 'nom',
        value: 'nouveau-nom',
        label: 'Entrer un nouveau nom de séance...',
      });
  ...
  function handleClick(event) {
    ...
    setClicked(
      clicked
        .slice(0, e)
        .concat([!clicked[e]], clicked.slice(e + 1, clicked.length))
    );
  ...
  function handleClickDetail(event) {
    ...
    setClickedDetail(
      clickedDetail
        ...
        .concat(
          [!clickedDetail[e]],
          clickedDetail.slice(e + 1, clickedDetail.length)
        )
    );
  ...
  async function handleClickSuppr(event) {
    const res = await API.supprSeance({
      id: localStorage.getItem('id'),
      seanceId: event.target.id,
    });
  ...
  function exportTableToCSV(html, filename) {
    ...
    csv.push([
      'ProgrArmor outil ultime de la progression sportive: journal et historique programme statistiques de tes amis et autre',
    ]);
      ...
      {seances.length === 0 ? (
        ...
        <div className="Dashboard">
          ...
          <form className="debutant-form">
            <h2 onClick={handleClickFiltrage}>
              Filtrage
              <img
                className={
                  clickFiltrage
            ...
            <div className={clickFiltrage ? 'extended' : 'not-extended'}>
              <div className="form-group row">
                <div className="form-group col-6">
                  <label className=" col-form-label">Tri</label>
                  <Select
                    ...
                    options={[
                      {
                        id: 'tri',
                        label: 'Ordre chronologique décroissant (défaut)',
                        value: 'Ordre chronologique décroissant',
                      },
                      {
                        id: 'tri',
                        label: 'Ordre chronologique croissant',
                        value: 'Ordre chronologique croissant',
                      },
                      {
                        id: 'tri',
                        label: 'Charge (ordre décroissant)',
                        value: 'Charge (ordre décroissant)',
                      },
                      {
                        id: 'tri',
                        label: '%PDC (ordre décroissant)',
                        value: 'PDC (ordre décroissant)',
                      },
                    ]}
                    styles={
                ...
                <div className="form-group col-6">
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      {
                        id: 'periode',
                        label: '90 derniers jours (3 mois)',
                        value: '90d',
                      },
                      {
                        id: 'periode',
                        label: '180 derniers jours (6 mois)',
                        value: '180d',
                      },
              ...
              <div className="form-group row">
                <div className="form-group col-6">
                  ...
                  <ExerciceInput
                    ...
                    modeSombre={user.modeSombre ? true : false}
                ...
                <div className="form-group col-6">
                  <label className="col-form-label">Reps / Temps</label>
                  <input
                    type="text"
                    className={
                      user.modeSombre
                    ...
                    id="repsFrom"
                  />
                  <label className="col-form-label">à</label>
                  <input
                    type="text"
                    className={
                      user.modeSombre
            ...
            <h2 onClick={handleClickAffichage}>
              Affichage
              <img
                className={
                  clickAffichage
              ...
              <div className="form-group row">
                <div className="form-group group-margin 2">
                  <input
                    ...
                    id="affichageNom"
                  />
                  <label className="col-form-label" htmlFor="#affichageNom">
                    {' '}
                    Nom{' '}
                  </label>
                  ...
                  <input
                    ...
                    id="affichageDate"
                  />
                  <label className="col-form-label" htmlFor="#affichageDate">
                    {' '}
                    Date{' '}
                  </label>
                  ...
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichagePoids"
                    id="affichagePoids"
                  />
                  <label className="col-form-label" htmlFor="#affichagePoids">
                    {' '}
                    Poids{' '}
                  </label>
                  ...
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichageExercice"
                    id="affichageExercice"
                  />
                  <label
                    className="col-form-label"
                    htmlFor="#affichageExercice"
                  >
                    {' '}
                    Exercice{' '}
                  </label>
                  ...
                  <input
                    ...
                    id="affichageType"
                  />
                  <label className="col-form-label" htmlFor="#affichageType">
                    {' '}
                    Type{' '}
                  </label>
                  ...
                  <input
                    ...
                    id="affichageReps"
                  />
                  <label className="col-form-label" htmlFor="#affichageReps">
                    {' '}
                    Reps{' '}
                  </label>
                  ...
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichageCharge"
                    id="affichageCharge"
                  />
                  <label className="col-form-label" htmlFor="#affichageCharge">
                    {' '}
                    Charge{' '}
                  </label>
                  ...
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichagePercent"
                    id="affichagePercent"
                  />
                  <label
                    className="col-form-labell"
                    htmlFor="#affichagePercent"
                  >
                    {' '}
                    % PDC{' '}
                  </label>
              ...
              <div className="form-group row">
                <div className="form-group col-4">
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichageModif"
                    id="affichageModif"
                  />
                  <label className="col-form-label" htmlFor="#affichageModif">
                    {' '}
                ...
                <div className="form-group group-margin-last col-4">
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichageSuppr"
                    id="affichageSuppr"
                  />
                  <label className="col-form-label" htmlFor="#affichageSuppr">
                    {' '}
                ...
                <div className="form-group group-margin-last col-4">
                  <input
                    ...
                    className="col-form-control"
                    onChange={handleChangeCheckbox}
                    value="affichageExport"
                    id="affichageExport"
                  />
                  <label className="col-form-label" htmlFor="#affichageExport">
                    {' '}
      ...
      {seances.length === 0 ? null : (
        <div className="Dashboard">
          {checkbox.affichageExport ? (
            <button
              className="btn btn-lg btn-dark large-margin-bottom"
          ...
          <table
            className={
              switched
                ? 'table table-hover table-responsive-lg table-dark dashboard-table'
                : 'table table-hover table-responsive-lg dashboard-table'
            }
          >
                ...
                if (seance !== null) {
                  return seance.exercices.map((exercice, indexExercice) => {
                    if (exercice !== null) {
                      return (
                        exercice.Series &&
                        Object.values(exercice.Series).map(
                          (serie, indexSerie) => {
                            if (serie !== null) {
                              return (
                                <tr
                                  style={
                                    switched
                                      ? trStyleBlack(indexSeance)
                                      : trStyleWhite(indexSeance)
                                  }
                                >
                                  {checkbox.affichageModif ? (
                                    indexExercice === 0 ? (
                                      indexSerie === 0 ? (
                                        <td
                                          style={
                                            switched
                                              ? tdStyleBlack(indexExercice)
                                              : tdStyleWhite(indexExercice)
                                          }
                                  ...
                                  {checkbox.affichageExercice ? (
                                    <td
                                      ...
                                      className="dashboard-td"
                                    >
                                      {exercice.exercice.name === 'own-exercice'
                                  ...
                                  {checkbox.affichageType ? (
                                    <td
                                      ...
                                      className="dashboard-td"
                                    >
                                      {serie.typeSerie === 'reps'
                                        ? 'Répétitions'
                                        : null}
                                      {serie.typeSerie === 'time'
                                        ? 'Temps (sec)'
                                        : null}
                                    </td>
                                  ) : null}
                                  ...
                                  {detailsAddRien.map((rien, index) => {
                                    if (seance.details) {
                                      if (
                                        Object.values(seance.details)[index]
                                      ) {
                                        return (
                                          <td
                                            style={
