...
function CategorieInput(props) {
  ...
  const [streetworkoutHiddenClicked, setStreetworkoutHiddenClicked] =
    useState('hide');
  ...
  function handleClickStreetworkout() {
    if (streetworkoutHiddenClicked === 'hide') {
      ...
      setStreetworkoutHiddenClicked('hide');
    }
  }
  ...
  return (
    <div style={divStyle(props.index, props.modeSombre)} className="Categorie">
      {categorie.name ? null : props.info === 'false' ? (
        <Select
        ...
        <div className="form-group row">
          {props.info === 'false' ? null : !props.dashboard ? (
            <div>
              <label>
                Catégorie {props.dashboard ? props.index + 1 : null}{' '}
                {props.dimensions > 500
                  ? '(' + props.exercice.name + ')'
                  : null}
              </label>
              <img
            ...
            {props.info === 'false' ? null : (
              <label>
                ...
                <img
                  ...
                  onClick={handleClickStreetworkout}
                  src={require('../../images/icons/icons8-question-mark-96.webp')}
                  alt="?"
                />
      ...
      {categorie.name === 'Type de barre / poids' ? (
        props.info === 'false' ? (
          ...
          <div className="form-group row">
            {props.info === 'false' ? null : (
              <label className="col-12">{categorie.name}</label>
            )}
            <Select
              placeholder="Categorie..."
              onChange={handleChange}
        ...
        props.info === 'false' ? (
          <div>
            <Select
              ...
              value={{
                value: categorie.utilisation,
                label: categorie.utilisation,
              }}
            />
          ...
          <div className="form-group row">
            {props.info === 'false' ? null : (
              <label className="col-12">Utilisation</label>
            )}
            <Select
              placeholder="Utilisation..."
              onChange={handleChange}
          ...
          <div>
            ...
            <div className="form-group row">
              <label className="col-12">Épaisseur / taille élastique</label>
              <Select
                placeholder="Categorie..."
                onChange={handleChange}
            ...
            {categorie.input === 'mesure' ? (
              <div className="form-group row">
                <label className="col-12">Tension (kg)</label>
              ...
              <div>
                <div className="form-group row slider-style">
                  <label className="col-12">Etirement (mètres)</label>
                  {props.modeSombre === true ? (
                    <StyleSliderBlack
                      style={{
                        width: '74%',
