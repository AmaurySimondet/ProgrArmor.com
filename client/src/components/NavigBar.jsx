          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div>
              <div
                className={
                  toggled
                    ? 'toggle-is-clicked extended'
                    : 'toggle-is-clicked not-extended'
                }
                style={toggled ? null : { border: '0' }}
              ></div>

              <table
                className={
                  toggled
                    ? 'param-choice-toggle visible'
                    : 'param-choice-toggle not-visible'
                }
              >
                <tbody>
                  <tr>
                  ...
                  <div className="div-navigbar-text">
                    <tr>
                      <td>
                        <a className="param-choice" href="/compte">
                          {' '}
                          Compte{' '}
                        </a>
                      </td>
                    ...
                    <tr>
                      <td>
                        <a className="param-choice" href="/aide">
                          {' '}
                          Aide{' '}
                        </a>
                      </td>
                    ...
                    <tr>
                      <td>
                        <a className="param-choice" href="/a_propos">
                          {' '}
                          A propos{' '}
                        </a>
                      </td>
                    ...
                    <tr>
                      <td>
                        <a className="param-choice" href="/CGU">
                          {' '}
                          CGU{' '}
                        </a>
                      </td>
        ...
        <div>
          ...
          <div>
            <div
              className={
                gearIsClicked
                  ? 'gear-is-clicked extended'
                  : 'gear-is-clicked not-extended'
              }
            >
      ...
      {props.show === true ? (
        clickedWarning ? null : (
          <div className="warning-border">
            <div className="text">
              <p className="La-croix" onClick={handleClickWarning}>
                {' '}
                <strong> X </strong>{' '}
              </p>
              ...
              <p>
                {' '}
                - que ProgrArmor se garde tout droit concernant votre accès à ce
                site,{' '}
              </p>
              <p>
                {' '}
                - que ProgrArmor se garde tout droit concernant vos données, et
                que celles-ci pourraient être supprimées pour des raisons de
                développement ou pour tout autre raison,{' '}
              </p>
              <p>
                {' '}
                - que le site peut comporter de nombreux bugs et manquer de
                fonctionnalités,{' '}
              </p>
              <br />
              <p>
                {' '}
                Vous êtes donc conviez à indiquer toute suggestion et tout bug
                avec un maximum {"d'information "}
                en message direct sur{' '}
                {"l'un de nos réseaux ou par tout autre moyen"}
              </p>
            </div>
          </div>
        )
