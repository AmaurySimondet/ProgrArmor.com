    ...
    <div>
      ...
      <div className="basic-div">
        <h1 className="">
          Programmes
          <button
            className="btn btn-dark large-margin-left"
        ...
        <div>
          <h2 onClick={handleClickFiltrage} style={{ display: 'inline-block' }}>
            Filtrage
            <img
              className={
                clickFiltrage
          ...
          <div
            className={
              clickFiltrage
                ? 'tri large-perc-margin-updown extended'
                : 'tri large-perc-margin-updown not-extended'
            }
          >
            <div className="form-group row">
              ...
              <div className="col-4">
                ...
                <input
                  type="checkbox"
                  checked={searchParamsValues.ownedByMe}
                  className={
                    user.modeSombre === true
                      ? 'inputDark form-control'
                      : 'form-control'
              ...
              <div className="col-4">
                ...
                <input
                  type="checkbox"
                  checked={searchParamsValues.likedByMe}
                  className={
                    user.modeSombre === true
                      ? 'inputDark form-control'
                      : 'form-control'
              ...
              <div className="col-4">
                ...
                <input
                  type="checkbox"
                  checked={searchParamsValues.commentedByMe}
                  className={
                    user.modeSombre === true
                      ? 'inputDark form-control'
                      : 'form-control'
                  ...
                  onChange={(e) => {
                    ...
                    newParams.set(
                      'commentedByMe',
                      !searchParamsValues.commentedByMe
                    );
                    setSearchParams(newParams);
                  }}
                />
              ...
              <div className="col-12">
                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    newParams.set(
                      'materiel',
                      e.map((materiel) => materiel.value).join(';') || ''
                    );
                    setSearchParamsValues({
                      ...searchParamsValues,
                      materiel: e,
