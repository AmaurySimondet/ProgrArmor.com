    ...
    return (
      <div className="custom-tooltip">
        ...
        {payload.map((payload) => {
          if (payload.dataKey === 'exercices[0].Series[0].repsTime') {
            return (
              <div key={payload.name}>
                ...
                <p className="chart-desc">
                  Reps / Temps : {payload.value / 10}
                </p>
              </div>
            );
          }
          if (payload.dataKey === 'exercices[0].Series[0].charge') {
            return <p key={payload.name} className="chart-desc">Charge : {payload.value}</p>;
          }
          if (payload.dataKey === 'exercices[0].Series[0].percent') {
            return <p key={payload.name} className="chart-desc">% PDC : {payload.value}</p>;
          }
          if (payload.dataKey === 'poids') {
            return <p key={payload.name} className="chart-desc">Poids : {payload.value}</p>;
          }
          if (payload.dataKey === 'repsTime') {
            return (
              <p key={payload.name} className="chart-desc">
          ...
          if (
            payload.dataKey === 'exercices[0].Categories[0].assistance' ||
            payload.dataKey === 'exercices[0].Categories[1].assistance' ||
            payload.dataKey === 'exercices[0].Categories[2].assistance' ||
            payload.dataKey === 'exercices[0].Categories[3].assistance' ||
            payload.dataKey === 'exercices[0].Categories[4].assistance'
          ) {
            return (
              <p key={payload.name} className="chart-desc">
                {' '}
                Assistance élastique (kg) : {payload.value}
              </p>
            );
          }
          if (
            payload.dataKey === 'exercices[0].Categories[0].resistance' ||
            payload.dataKey === 'exercices[0].Categories[1].resistance' ||
            payload.dataKey === 'exercices[0].Categories[2].resistance' ||
            payload.dataKey === 'exercices[0].Categories[3].resistance' ||
            payload.dataKey === 'exercices[0].Categories[4].resistance'
          ) {
            return (
              <p key={payload.name} className="chart-desc">
                {' '}
                Resistance élastique (kg) : {payload.value}
              </p>
            );
          }
        })}
...
const CustomTooltipRegu = ({ active, payload }) => {
  if (active && payload && payload.length) {
    return (
      <div className="custom-tooltip">
        <p className="chart-desc">
          {payload[0].payload.name} : {payload[0].payload.score.toFixed(2)}
        </p>
      </div>
    );
  }
...
function Stats() {
  ...
  const [exercice, setExercice] = useState({
    exercice: { name: 'title', ownExercice: '' },
  });
      ...
      {seances1.length === 0 &&
        ...
        <div className="Travaux-div">
          ...
          <p>
            {' '}
            {
              "Je suis désolé, j'aurais vraiment aimé te fournir des statistiques sur rien mais on va pas réinventer les maths juste pour toi..."
            }{' '}
          </p>
        ...
        <div className="Stats-div">
                ...
                <td>
                  <div className="chart-poids">
                    ...
                    <div
                      className={
                        poidsHidden
                          ? 'large-margin-bottom not-extended'
                          : 'large-margin-bottom extended'
                      }
                    >
                      <div className="form-group row stats-form mini-margin-bottom">
                        <div className="form-group col-12">
                          ...
                          >
                            ...
                            <option value="90d">
                              {' '}
                              90 derniers jours (3 mois){' '}
                            </option>
                            <option value="180d">
                              {' '}
                              180 derniers jours (6 mois){' '}
                            </option>
                      ...
                      <div className="form-group row stats-form mini-margin-bottom">
                        <div className="form-group col-12">
                          <label className="col-form-label">Format Date</label>
                          <select
                            onChange={handleChange1}
                            className={
                              user.modeSombre === true
                    ...
                    <p>
                      {' '}
                      Evolution de ton poids sur la période {
                        params1.periode
                      }{' '}
                    </p>
                    ...
                    <ResponsiveContainer
                      width="100%"
                      height={dimensions.width < 500 ? 280 : 400}
                      className={
                        user.modeSombre === true
                          ? 'chart watermark watermarkDark'
                          : 'chart watermark'
                      }
                    >
                      <LineChart
                      ...
                      >
                        ...
                        <YAxis
                          ...
                          domain={[
                            parseInt(infoPoids.poidsMin * 0.98),
                            parseInt(infoPoids.poidsMax * 1.02),
                          ]}
                        />
                        <Tooltip content={<CustomTooltip />} />
                        <CartesianGrid
                          fill={user.modeSombre === true ? 'black' : 'white'}
                          stroke="#f5f5f5"
                        />
                        <Line
                          strokeWidth={3}
                          ...
                          dataKey="poids"
                          stroke={
                            user.modeSombre === true ? '#ff6666' : '#ff0000'
                          }
                        />
                      </LineChart>
                    </ResponsiveContainer>
                    ...
                    <div className="chart-poids">
                      ...
                      >
                        <div className="form-group row stats-form mini-margin-bottom">
                          <div className="form-group col-4">
                            ...
                            <ExerciceInput
                              ...
                              modeSombre={
                                user.modeSombre === true ? true : false
                              }
                              taille="petit"
                              typeSerie={0}
                              id="exercice"
                          ...
                          <div className="form-group col-4">
                            <label
                              onClick={handleClick}
                              className="col-form-label categorie-label"
                            >
                              Catégorie{' '}
                              <img
                                className={
                                  user.modeSombre === true
                                    ? 'reset-img  questionDark'
                                    : 'reset-img'
                                }
                                onClick={handleClick}
                                src={require('../../images/icons/reset.webp')}
                              />
                            </label>
                            <CategorieInput
                              dimensions={dimensions}
                          ...
                          <div className="form-group col-4">
                            ...
                            >
                              <option value={'percent'}>
                                {' '}
                                Pourcentage du poids de corps (défaut){' '}
                              </option>
                        ...
                        <div className="form-group row stats-form mini-margin-bottom">
                          ...
                          <div className="form-group col-4">
                            <label
                              ...
                              className="col-form-label detail-label"
                            >
                              Détail{' '}
                              <img
                                className={
                        ...
                        <div className="form-group row stats-form basic-margin-top mini-margin-bottom">
                          ...
                          <input
                            ...
                            id="repsFrom"
                          />
                          <label className="col-form-label col-1">à</label>
                          <input
                            type="text"
                            className={
                              user.modeSombre === true
                      ...
                      >
                        ...
                        >
                          ...
                          <YAxis
                            ...
                            tickFormatter={
                              typePerfGraph === 'percent' ? formatYAxis : null
                            }
                          />
                          <Tooltip content={<CustomTooltip />} />
                          <CartesianGrid
                          ...
                          <Bar
                            barSize={20}
                            fill={
                              user.modeSombre === true ? '#626262' : '#afafaf'
                            }
                            dataKey="exercices[0].Series[0].repsTime"
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Series[0].' + typePerfGraph}
                            stroke={
                              user.modeSombre === true ? '#ff6666' : '#ff0000'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[0].resistance'}
                            stroke={
                              user.modeSombre === true ? '#4DBAFF' : '#10669C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[1].resistance'}
                            stroke={
                              user.modeSombre === true ? '#4DBAFF' : '#10669C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[2].resistance'}
                            stroke={
                              user.modeSombre === true ? '#4DBAFF' : '#10669C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[3].resistance'}
                            stroke={
                              user.modeSombre === true ? '#4DBAFF' : '#10669C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[4].resistance'}
                            stroke={
                              user.modeSombre === true ? '#4DBAFF' : '#10669C'
                            }
                          />
                          ...
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[0].assistance'}
                            stroke={
                              user.modeSombre === true ? '#66E891' : '#24B34C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[1].assistance'}
                            stroke={
                              user.modeSombre === true ? '#66E891' : '#24B34C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[2].assistance'}
                            stroke={
                              user.modeSombre === true ? '#66E891' : '#24B34C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[3].assistance'}
                            stroke={
                              user.modeSombre === true ? '#66E891' : '#24B34C'
                            }
                          />
                          <Line
                            strokeWidth={3}
                            type="monotone"
                            dataKey={'exercices[0].Categories[4].assistance'}
                            stroke={
                              user.modeSombre === true ? '#66E891' : '#24B34C'
                            }
                          />
                      ...
                      <div className="chart-legende">
                        ...
                        <p style={{ margin: 'auto' }}>
                          {' '}
                          {typePerfGraph === 'percent'
                            ? 'Performance en % Poids Du Corps'
                            : 'Performance en charge (kg)'}{' '}
                        </p>
                        <hr
                          style={
                            user.modeSombre === true
                        ...
                        <p style={{ margin: 'auto' }}>
                          {' '}
                          Resistance élastique estimée/mesurée en kg{' '}
                        </p>
                        <hr
                          style={
                            user.modeSombre === true
                        ...
                        <p style={{ margin: 'auto' }}>
                          {' '}
                          Assistance élastique estimée/mesurée en kg{' '}
                        </p>
                        <hr
                          style={
                            user.modeSombre === true
                      ...
                      <i className="detail-stat">
                        {' '}
                        Les répétitions sont multipliées par 10 pour une
                        meilleur lecture{' '}
                      </i>
                      <br />
                    </div>
          ...
          <div className="chart-pie">
            <h1 className="chart-title" onClick={handleClickPref}>
            ...
            >
              <div className="form-group row stats-form mini-margin-bottom">
                ...
                <div className="form-group col-4">
                  <label className="col-form-label">Affichage</label>
                  <select
                    onChange={handleChange3}
                    className={
                      user.modeSombre === true
            ...
            <div ref={imageRef}>
              <ResponsiveContainer
                className={
                  user.modeSombre === true
                    ? 'piechart watermark-piechart watermarkDark'
                    : 'piechart watermark-piechart'
                }
                width="100%"
                height={
          ...
          {reguScore ? (
            <div className="regu-score">
              ...
              >
                ...
                <img
                  className={
                    user.modeSombre === true ? 'myDIV questionDark ' : 'myDIV'
                  }
                  onClick={handleClickRegu}
                ...
                <h2 style={{ fontSize: 'large' }}>
                  {' '}
                  Ta série de semaines consécutives avec séance actuelle:{' '}
                </h2>
                <h2 style={{ fontSize: 'large' }}> {reguScore.currSerie} </h2>

                <h2 style={{ fontSize: 'large' }}>
                  {' '}
                  Ta meilleure série de séances consécutives:{' '}
                </h2>
                <h2 style={{ fontSize: 'large' }}> {reguScore.bestSerie} </h2>

                <h2 style={{ fontSize: 'large' }}>
                  {' '}
                  Ta moyenne de séances consécutives:{' '}
                </h2>
                <h2 style={{ marginBottom: '20px', fontSize: 'large' }}>
                  {' '}
                  {reguScore.AverageSerie.toFixed(2)}{' '}
                </h2>
              </p>
              ...
              <ResponsiveContainer
                ...
                className={
                  user.modeSombre === true
                    ? 'regu-score watermark-regu watermark watermarkDark rotate'
                    : 'regu-score watermark-regu watermark rotate'
                }
              >
                <BarChart data={reguScore.reguScore}>
                  <XAxis
                    tick={
                      user.modeSombre === true
                        ? { fill: 'white' }
                  ...
                  <YAxis
                    ...
                    tickLine={
                      user.modeSombre === true ? { stroke: 'white' } : null
                    }
                  />
                  ...
                  <Bar
                    barSize={100}
                    fill={user.modeSombre === true ? '#626262' : '#afafaf'}
                    dataKey="score"
                  >
                    {reguScore.reguScore.map((entry) => (
                      <Cell key={`cell-${entry.score}`}
                        fill={
                          entry.score < 25
                            ? '#F7A4A4'
                            : entry.score < 50
            ...
            <div className="regu-score">
              ...
              <p>
                {' '}
                Je ne peux pas calculer un score de régularité avec une seule
                séance, retourne t&rsquoentraîner !
              </p>
            </div>
          )}
        </div>
