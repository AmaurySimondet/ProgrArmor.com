      ...
      <div className="custom-tooltip">
        ...
        {payload.map((payload) => {
          ...
          if (payload.dataKey === 'repsTime') {
            return (
              <p className="desc"> Valeur classification : {payload.value}</p>
            );
          }
          if (
            payload.dataKey === 'exercices[0].Categories[0].estimation' ||
            payload.dataKey === 'exercices[0].Categories[1].estimation' ||
            payload.dataKey === 'exercices[0].Categories[2].estimation' ||
            payload.dataKey === 'exercices[0].Categories[3].estimation' ||
            payload.dataKey === 'exercices[0].Categories[4].estimation'
          ) {
            return (
              <p className="desc">
                {' '}
                Élastique estimation (kg) : {payload.value}
              </p>
            );
          }
        })}
      ...
      {numUsers !== 1 ? (
        <div className="Admin chart-pie">
          ...
          <div className="chart-pie section">
            ...
            <ResponsiveContainer
              className="piechart watermark-piechart"
              width="100%"
              height={
