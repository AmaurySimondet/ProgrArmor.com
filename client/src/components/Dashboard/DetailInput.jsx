    ...
    <div style={divStyle(props.index, props.modeSombre)}>
      {detail.name ? null : (
        <div>
          {props.info === 'false' ? null : (
            <label>Detail {props.index + 1}</label>
          )}
          ...
          {props.dashboard ? null : (
            <div style={{ display: 'inline-block' }}>
              <img
                ...
                alt={props.modeSombre === true ? 'poubelleDark' : 'poubelle'}
              />
            </div>
          )}
      ...
      {detail.name === 'Aucun' ? (
        <div className="form-group row">
          {props.info === 'false' ? null : (
            <label>Detail {props.dashboard ? props.index + 1 : null}</label>
          )}
      ...
      {detail.name === 'Notes' ? (
        props.info === 'false' ? (
          ...
          <div className="form-group row">
            {props.info === 'false' ? null : <label>{detail.name}</label>}
            <div className={props.info === 'false' ? '' : 'col-10'}>
              <textarea
                type="text"
                className="form-control"
