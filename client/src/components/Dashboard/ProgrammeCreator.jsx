...
function ProgrammeCreator(props) {
  ...
  function handleDeletePeriodisation(id) {
    setProgramme({
      ...programme,
      programme: programme.programme.filter(
        (periodisation) => periodisation.id !== id
      ),
    });
  }
      ...
      <div className="basic-div">
        ...
        >
          <div style={{ paddingRight: '40px' }}>
            ...
            <p>
              {' '}
              <i> Toute progression sera perdue </i>{' '}
            </p>
          </div>
        ...
        <div>
          <button
            className="btn btn-black block basic-margin-bottom-and-auto"
          ...
          <div className="form-group row">
            ...
            <div className="col-4 basic-margin-updown">
              ...
              <Select
                options={TypesDeProgrammes}
                placeholder="Type de programme..."
                onChange={handleChange}
                value={{
                  id: programme.type.id,
                  label: programme.type.label,
                  value: programme.type.value,
                }}
            ...
            <div className="col-4 basic-margin-updown">
              ...
              <Select
                ...
                onChange={handleChange}
                value={{
                  id: programme.niveau.id,
                  label: programme.niveau.label,
                  value: programme.niveau.value,
                }}
                styles={styleOnDim(dimensions, user)}
              />
            </div>
          ...
          <button
            ...
            onClick={closingPeriodisations}
            disabled={programme.programme.length > 0 ? false : true}
          >
            {periodisationsClosed
              ? 'Ouvrir toutes les periodisations'
              : 'Résumer toutes les periodisations'}
          </button>
          ...
          <button
            className="btn btn-black block large-margin-updown"
